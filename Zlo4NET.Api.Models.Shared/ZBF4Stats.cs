...
public class ZBF4Stats : ZStatsBase
{
	...
	public short Time => (short)Math.Floor(_player["timePlayed"].ToObject<double>() / 60.0 / 60.0);
	...
	public float AssaultCurrentScore => _kits["assault"]["stars"]["curr"].ToObject<float>() - AssaultScoreMax * (float)(int)AssaultStarsCount;
	...
	public float EngineerCurrentScore => _kits["engineer"]["stars"]["curr"].ToObject<float>() - EngineerScoreMax * (float)(int)EngineerStarsCount;
	...
	public float ReconCurrentScore => _kits["recon"]["stars"]["curr"].ToObject<float>() - ReconScoreMax * (float)(int)ReconStarsCount;
	...
	public float SupportCurrentScore => _kits["support"]["stars"]["curr"].ToObject<float>() - SupportScoreMax * (float)(int)SupportStarsCount;
